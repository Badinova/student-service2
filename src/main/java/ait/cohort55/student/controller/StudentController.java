...
public class StudentController {
    ...
    public List<StudentDto> findStudentsByNane(@PathVariable String name) {
    ...
    public List<StudentDto> findStudentsByExamNaneMinScore(@PathVariable String exam, @PathVariable Integer minScore) {
